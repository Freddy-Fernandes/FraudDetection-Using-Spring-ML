...
public class MLFraudDetectionService {
    ...
    /**
     * Returns a rule-based fraud probability score (0.0 - 10.0).
     * ML model placeholder - scoring is handled by RuleBasedFraudDetectionService.
     */
    public double predictFraudProbability(Transaction transaction, UserBehavior behavior) {
        log.debug("ML scoring skipped - using rule-based detection only");
        return 0.0;
    }
}